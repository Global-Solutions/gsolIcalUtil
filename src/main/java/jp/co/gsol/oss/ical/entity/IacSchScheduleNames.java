...
/**
 * {@link IacSchSchedule}のプロパティ名の集合です。
 * 
...
public class IacSchScheduleNames {
    ...
    /**
     * reserveFacilityListのプロパティ名を返します。
     * 
     * @return reserveFacilityListのプロパティ名
     */
    public static PropertyName<String> reserveFacilityList() {
        return new PropertyName<String>("reserveFacilityList");
    }
    ...
    /**
     * iacSchParticipantListのプロパティ名を返します。
     * 
     * @return iacSchParticipantListのプロパティ名
     */
    public static _IacSchParticipantNames iacSchParticipantList() {
        return new _IacSchParticipantNames("iacSchParticipantList");
    }

    /**
     * @author Global Solutions Co., Ltd.
     */
    public static class _IacSchScheduleNames extends PropertyName<IacSchSchedule> {

        /**
         * インスタンスを構築します。
         */
        public _IacSchScheduleNames() {
        }
         ...
         *            名前
         */
        public _IacSchScheduleNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _IacSchScheduleNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return reserveFacilityListのプロパティ名
         */
        public PropertyName<String> reserveFacilityList() {
            return new PropertyName<String>(this, "reserveFacilityList");
        }
         ...
         * @return iacSchParticipantListのプロパティ名
         */
        public _IacSchParticipantNames iacSchParticipantList() {
            return new _IacSchParticipantNames(this, "iacSchParticipantList");
        }
    }
}