...
/**
 * {@link IcalUpdateQueue}のプロパティ名の集合です。
 * 
...
public class IcalUpdateQueueNames {
     ...
     * @author Global Solutions Co., Ltd.
     */
    public static class _IcalUpdateQueueNames extends PropertyName<IcalUpdateQueue> {

        /**
         * インスタンスを構築します。
         */
        public _IcalUpdateQueueNames() {
        }
         ...
         *            名前
         */
        public _IcalUpdateQueueNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _IcalUpdateQueueNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
