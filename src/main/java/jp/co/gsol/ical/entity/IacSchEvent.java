...
public class IacSchEvent implements Serializable {
    ...
    /** iacSchEventParticipantList関連プロパティ */
    @OneToMany(mappedBy = "iacSchEvent")
    public List<IacSchEventParticipant> iacSchEventParticipantList;
}
