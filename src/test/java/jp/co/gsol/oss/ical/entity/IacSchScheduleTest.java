...
public class IacSchScheduleTest {
    ...
    public void testFindById() throws Exception {
        jdbcManager.from(IacSchSchedule.class).id("aaa").getSingleResult();
    }

    /**
     * iacSchParticipantListとの外部結合をテストします。
     * 
     * @throws Exception
     */
    public void testLeftOuterJoin_iacSchParticipantList() throws Exception {
        jdbcManager.from(IacSchSchedule.class).leftOuterJoin(iacSchParticipantList()).id("aaa").getSingleResult();
    }
}