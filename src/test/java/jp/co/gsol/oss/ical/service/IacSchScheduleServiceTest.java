...
/**
 * {@link IacSchScheduleService}のテストクラスです。
 * 
...
public class IacSchScheduleServiceTest {

    private IacSchScheduleService iacSchScheduleService;

    /**
     * {@link #iacSchScheduleService}が利用可能であることをテストします。
     * 
     * @throws Exception
     */
    public void testAvailable() throws Exception {
        assertNotNull(iacSchScheduleService);
    }
}